...
public class DevelopmentConfig {
    ...
    @Bean
    public CommandLineRunner demoData(BooksRepository booksRepository) {

        if (booksRepository.count() == 0) {
            return args -> {
                booksRepository.save(new Books("Spring MVC Cookbook", "Alex Bretet",
                        new SimpleDateFormat("yyyy").parse("2016"), "Welcome to the singular" +
                ...
                booksRepository.save(new Books("Apache Maven 3 Cookbook", "Srirangan",
                        new SimpleDateFormat("yyyy").parse("2011"), "Apache Maven is more" +
                ...
                booksRepository.save(new Books("Spring in Action", "Walls C.",
                        new SimpleDateFormat("yyyy").parse("2019"), "Spring in Action, Fifth" +
                ...
                booksRepository.save(new Books("Spring Data", "Pollack M., Gierke O., Risberg T.," +
                        " Brisbin J., Hunger M.",
                        new SimpleDateFormat("yyyy").parse("2012"), "The Spring Data project" +
                ...
                booksRepository.save(new Books("Pro Spring Boot", "Felipe Gutierrez.",
                        new SimpleDateFormat("yyyy").parse("2019"), "The Spring Framework was" +
