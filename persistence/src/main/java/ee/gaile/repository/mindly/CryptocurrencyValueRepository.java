...
@Repository
public interface CryptocurrencyValueRepository extends JpaRepository<CryptocurrencyValues, Long> {
    ...
    CryptocurrencyValues findByCryptocurrencyNameAndLastDate(@Param("cryptocurrencyName") String cryptocurrencyName);
}
